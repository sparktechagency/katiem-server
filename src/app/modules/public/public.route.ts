...
router.get('/contact/all', auth(USER_ROLES.ADMIN), PublicController.getAllContacts)

router.post(
  '/contact/reply/:id',
  auth(USER_ROLES.ADMIN),
  validateRequest(PublicValidation.updateContactZodSchema),
  PublicController.ReplyContact,
)
router.delete('/contact/:id', auth(USER_ROLES.ADMIN), PublicController.deleteContact)
