...
router.get('/contact/all', (0, auth_1.default)(user_1.USER_ROLES.ADMIN), public_controller_1.PublicController.getAllContacts);
router.post('/contact/reply/:id', (0, auth_1.default)(user_1.USER_ROLES.ADMIN), (0, validateRequest_1.default)(public_validation_1.PublicValidation.updateContactZodSchema), public_controller_1.PublicController.ReplyContact);
router.delete('/contact/:id', (0, auth_1.default)(user_1.USER_ROLES.ADMIN), public_controller_1.PublicController.deleteContact);
