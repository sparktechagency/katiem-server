...
const getAllContacts = (0, catchAsync_1.default)(async (req, res) => {
    ...
    const filters = (0, pick_1.default)(req.query, ['searchTerm', 'isSolved']);
    const result = await public_service_1.PublicServices.getAllContacts(filters, pagination);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_codes_1.StatusCodes.OK,
        success: true,
...
const ReplyContact = (0, catchAsync_1.default)(async (req, res) => {
    const { id } = req.params;
    const contactData = req.body;
    const result = await public_service_1.PublicServices.ReplyContact(id, contactData);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_codes_1.StatusCodes.OK,
        success: true,
...
const deleteContact = (0, catchAsync_1.default)(async (req, res) => {
    const { id } = req.params;
    const result = await public_service_1.PublicServices.deleteContact(id);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_codes_1.StatusCodes.OK,
        success: true,
